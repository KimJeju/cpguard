...
REPORT_FIELDS = [
    ...
    ("org", "수행 기관/회사", "예: ○○시큐어"),
    ("client", "발주처/고객", "예: ○○공사"),
    ("system", "대상 시스템/사업명", "예: 지급결제플랫폼"),
    ("tester", "진단 담당자", "예: 홍길동"),
    ("tester_rank", "담당자 직급", "예: 프로 / 책임"),
    ("tester_email", "담당자 이메일", "예: hong@example.com"),
    ("tester_phone", "담당자 연락처", "예: 010-0000-0000"),
    ("period", "진단 수행 기간", "예: 2026.08.01 ~ 2026.08.20"),
    ("tool", "진단 도구 표기", "비우면 CPGuard 와 버전이 자동으로 들어갑니다"),
